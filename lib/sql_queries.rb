...
SELECT projects.title, SUM(pledges.amount) - projects.funding_goal FROM projects, pledges JOIN pledges ON projects.id = pledges.project_id GROUP BY projects.id;
end
