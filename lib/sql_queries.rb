...
"SELECT projects.category, pledges.project_id FROM projects JOIN pledges ON projects.id = pledges.project_id GROUP BY projects.category WHERE projects.category = 'music';"
end
