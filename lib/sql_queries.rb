...
SELECT projects.title, SUM(pledges.amount) - projects.funding_goal as diff FROM projects, pledges HAVING projects.id = pledges.project_id AND diff >= '0' projects.id;
end
