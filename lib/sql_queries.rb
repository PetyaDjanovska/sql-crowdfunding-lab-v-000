...
SELECT projects.title, SUM(pledges.amount) - projects.funding_goal as diff FROM projects, pledges WHERE projects.id = pledges.project_id HAVING diff >= '0' projects.id;
end
