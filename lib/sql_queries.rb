...
SELECT projects.title, SUM(pledges.amount) - projects.funding_goal FROM projects, pledges WHERE projects.id = pledges.project_id HAVING (SUM(pledges.amount) - projects.funding_goal) >= '0' projects.id;
end
